      ...
      <div className="mb-48 text-center px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="bg-neutral-800 p-8 rounded-lg border border-neutral-700">
            ...
            <ul className="text-gray-400 space-y-2 mb-8 text-center">
          ...
          {/* New Enterprise Plan - Full Width */}
          <div className="bg-neutral-800 p-8 rounded-lg border border-neutral-700 md:col-span-3">
