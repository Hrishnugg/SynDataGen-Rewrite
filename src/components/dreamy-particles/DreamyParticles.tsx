...
export default function DreamyParticles({
  ...
  useEffect(() => {
    ...
    const bloomPass = new UnrealBloomPass(
      ...
      0.4, // radius
      0.4,
    ); // threshold - reduced to catch more particles
    ...
    return () => {
      ...
      if (gpgpuRef.current) {
        const { points, gpuCompute, positionVariable, velocityVariable } =
          gpgpuRef.current;
  ...
  useEffect(() => {
    ...
    const initParticles = (geometry: THREE.BufferGeometry) => {
      ...
      const originalPositionTexture = positionTexture
        ? positionTexture.clone()
        : null;
      ...
      velocityVariable.material.uniforms.uMouseStrength = {
        value: mouseStrength,
      };
      ...
      const animate = () => {
        ...
        velocityVariable.material.uniforms.uMouseSpeed.value =
          events.mouseSpeed * mouseStrength;
  ...
  return (
    <div
      className="dreamy-particles-container"
