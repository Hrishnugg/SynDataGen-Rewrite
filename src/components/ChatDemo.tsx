...
const ChatDemo = () => {
  ...
  const initialMessage: Message = {
    id: '1',
    type: 'assistant',
    content: 'Hi! I can help you generate synthetic data. What type of data are you looking for?',
  };

  const demoResponses: { [key: string]: string } = {
    'customer': 'I can help you generate realistic customer profiles while maintaining privacy. The synthetic data will preserve statistical patterns and relationships from your original dataset.',
    'financial': 'For financial data, I can generate synthetic transactions that maintain the temporal patterns and correlations while ensuring compliance with privacy regulations.',
    'healthcare': 'I can help create synthetic healthcare records that preserve patient privacy while maintaining the statistical validity needed for research and analysis.',
  };
  ...
  const simulateTyping = async (content: string) => {
    ...
    setMessages(prev => [...prev, { id: tempId, type: 'assistant', content: '', isTyping: true }]);
